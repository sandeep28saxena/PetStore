...
public class DBPopulator {
	...
	private void populateDB() {
		...
		addNewProducts("Bull Mastif",
				...
				"dog7.jpg", "Male Massive BullMastiff");
	}
	...
	private void initCatalog() {
		...
		reptile = new Category(
				"Reptiles",
				"Any of various cold-blooded, usually egg-laying vertebrates, such as a snake, lizard, crocodile, turtle");
		cat = new Category(
				"Cats",
				" Small carnivorous mammal domesticated since early times as a catcher of rats and mice and as a pet and existing in several distinctive breeds and varieties");
		bird = new Category(
				"Birds",
		...
		// Products
		Product angelfish = new Product("Angelfish",
		...
		Product bulldog = new Product("Bulldog", "Friendly dog from England",
				dog);
		Product poodle = new Product("Poodle", "Cute dog from France", dog);
		Product dalmation = new Product("Dalmation",
				"Great dog for a fire station", dog);
		Product goldenRetriever = new Product("Golden Retriever",
				"Great family dog", dog);
		Product labradorRetriever = new Product("Labrador Retriever",
				"Great hunting dog", dog);
		...
		Product rattlesnake = new Product("Rattlesnake",
				"Doubles as a watch dog", reptile);
		Product iguana = new Product("Iguana", "Friendly green friend", reptile);
		reptile.addProduct(rattlesnake);
		reptile.addProduct(iguana);

		Product manx = new Product("Manx",
				"Great for reducing mouse populations", cat);
		Product persian = new Product("Persian",
				"Friendly house cat, doubles as a princess", cat);
		cat.addProduct(manx);
		cat.addProduct(persian);

		Product amazonParrot = new Product("Amazon Parrot",
				"Great companion for up to 75 years", bird);
		...
		Item femaleRattlesnake = new Item(
				"Female Adult",
				20.00f,
				"reptile1.jpg",
				rattlesnake,
		...
		Item maleAmazonParrot = new Item(
				"Male Adult",
				120.00f,
				"bird2.jpg",
				amazonParrot,
		...
		Item femaleAmazonParrot = new Item(
				"Female Adult",
				120.00f,
				"bird2.jpg",
				amazonParrot,
	...
	private void initCustomers() {
		marc = new Customer("Marc", "Fleury", "marc", "marc", "marc@jboss.org",
				new Address("65 Ritherdon Road", "Los Angeles", "56421", "USA"));
		bill = new Customer("Bill", "Gates", "bill", "bill",
				"bill.gates@microsoft.com", new Address("27 West Side",
						"Alhabama", "8401", "USA"));
		steve = new Customer("Steve", "Jobs", "jobs", "jobs",
				"steve.jobs@apple.com", new Address("154 Star Boulevard",
						"San Francisco", "5455", "USA"));
		user = new Customer("User", "User", "user", "user",
				"user@petstore.org", new Address("Petstore", "Land", "666",
						"Nowhere"));
		admin = new Customer("Admin", "Admin", "admin", "admin",
				"admin@petstore.org", new Address("Petstore", "Land", "666",
						"Nowhere"));
	...
	public void addNewProducts(String name, String description,
		...
		Item itemTitle = new Item(name, itemCost, imagePath, title,
				description);
		title.addItem(itemTitle);
